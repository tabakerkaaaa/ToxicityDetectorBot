...
class ToxicDetector:
    def __init__(self):
        ...
        raw_lines = [preProcess(line.split(' ')) for line in stop_words_file.readlines()]
        ...
        self.pipeline = Pipeline([
            ...
            ('clf', LogisticRegressionCV(penalty='l1', cv=15, max_iter=200, verbose=1, solver='liblinear')),
        ])
